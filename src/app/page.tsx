...
export default function QuizPage() {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-white overflow-hidden text-gray-900">
      ...
      <div className="flex-none sticky top-0 bg-white border-b border-gray-200 z-10">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
          ...
          <h1 className="text-base font-bold text-gray-900">
            {quiz.category.split('・')[0]} {/* カテゴリ名の前半だけタイトルにする */}
          </h1>
          
          {/* 右側の余白（タイトルを中央にするためのダミー） */}
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        ...
        <div className="flex flex-col">
          {quiz.options.map((option, index) => {
            ...
            let badgeClass = "flex-none w-7 h-7 rounded-full flex items-center justify-center text-sm flex-shrink-0 ";
        ...
        {selected !== null && (
          <div className="px-5 py-6 mb-8 animate-fade-in">
            <h3 className="text-base font-bold mb-4">해설 (解説)</h3>
      ...
      {/* ===== 下部：ナビゲーション（固定） ===== */}
      <div className="flex-none flex items-center justify-between px-6 py-4 border-t border-gray-200 bg-white">
